						...
						while($row = mysqli_fetch_array($result))
						{
							...
							echo '<div class="col-md-4 mb-3">';
								echo '<div class="card" style="width:350px;height:500px; ">';
									echo '<div class="card-header bg-info text-white text-center outline-info">Lot</div>';
									echo '<div class="card-body text-center " >';
										...
										echo '<script>
											...
											echo'<script>
													$(document).ready(function(){
														document.getElementById("demo_'. $row['lot_id'] .'").innerHTML = "SOLD";
													});
												</script>';
										}
									// echo '</div>';
          ...
          <div class="col-lg-3 col-md-4">
            <div class="info">
              <div>
                ...
                <p>1060 Wellington Road<br>London, ON N6E 3W5</p>
              </div>

              <div>
                <i class="fa fa-envelope"></i>
                <p>winsave@bidbea.com</p>
              </div>
